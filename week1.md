...
이번 릴레이 프로젝트는 팀원들에게 전하고 싶은 명언이나 글귀 아니면 선한 영향력을 끼칠 수 있는 요소들을 AI에게 답변을 얻어내고 슬랙에 공유하기였는데, 구체적으로 어떤 상황에 대한, 어떤 느낌의, 대상을 설정하지 않고 AI에게 답변을 요구했는데, AI가 여러 상황에 따른 명언과 선한 영향력을 줄 수 있는 행동들을 분류해서 알려줘서 편하게 미션을 수행할 수 있었습니다. 미션을 선정했던 이유가 캠퍼분들에게 에너지를 전하기 위함이었는데, 좋은 글들을 슬랙에 공유한 것 같아서 기분이 좋았고, 구체적인 정보를 추가한다면 상황에 맞는 멋있는 글들을 답변으로 얻을 수 있겠다 느꼈습니다.
